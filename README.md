...
MCP server integration, automatic session-end indexing, and seamless conversation history search.
...
- **Issues**: https://github.com/cameronsjo/episodic-memory/issues
